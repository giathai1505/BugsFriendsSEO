var cntline;
var editor = document.getElementsByClassName('txt')[0];
...
function toggle(btn){
    ...
    switch (btn.value) {
        case "on":
            ...
            $(".txt").css("color","white");
            $(".solid").css("color","white");
            $(".rownr").css("background-color","black");
            $(".rownr").css("color","white");
            $(".inform").css("color","white");
            btn.value = "off";
            break;
        case "off":
            ...
            $(".txt").css("color","black");
            $(".rownr").css("background-color","white");
            $(".rownr").css("color","black");
